...
/**
 * This is the extension manager of the Clsso extension.
 */
public class ClssoManager extends GeneratedClssoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ClssoManager.class.getName());
	 ...
	 */
	public static ClssoManager getInstance()
	{
		return (ClssoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ClssoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ClssoManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ClssoManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ClssoManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ClssoManager called, current tenant: " + getTenant().getTenantID());
		}
	}
